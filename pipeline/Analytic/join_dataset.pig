...
zillow = LOAD 'step3' USING PigStorage('\t') AS (zpid:chararray, address:chararray, zipcode, beds, baths, size:int, price:int, months:int, lot:float, built:int);
...
STORE house_info INTO 'house_info_test';
